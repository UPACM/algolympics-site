...
In its thirteenth year, and with the theme **“Algolympics 2026: Dispatch**, the competition is divided into two phases: an **elimination round from March 14 - 23, 2026**, and a **final round on May 2, 2026**. Teams of one to three members develop their problem-solving, programming, and teamwork skills as they solve coding problems throughout the competition. Only the **top  twenty (25) teams** in the elimination round will be invited to the final round. See the mechanics for more details.
