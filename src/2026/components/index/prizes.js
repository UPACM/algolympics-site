...
import "./prizes.scss"
import contestDetails from "2026/data/details.json"
...
function Winner({ winnerData }) {
  return (
    <div className="winner">
      ...
      <p className={`team-name ${winnerData.smallFontSize ? 'small' : ''}`}>{winnerData.name}</p>
...
function Banner({ place, prize, winner, prevWinner }) {
  ...
  switch (place) {
    case "first":
      ...
      trophy_img_src = "/2023/assets/img/trophy-gold.webp"
      break
    case "second":
      prize_heading = "2nd place"
      trophy_img_src = "/2023/assets/img/trophy-silver.webp"
      aos_delay = "200"
      break
    case "third":
      prize_heading = "3rd place"
      trophy_img_src = "/2023/assets/img/trophy-bronze.webp"
      aos_delay = "300"
      break
    default:
      break
